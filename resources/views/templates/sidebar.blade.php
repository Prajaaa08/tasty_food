<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseRoles" class="collapse" aria-labelledby="headingRoles" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="/roles">Data Role</a>
                <a class="collapse-item" href="/roles/create">Form Role</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUsers" class="collapse" aria-labelledby="headingUsers" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/users/create">Form User</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseMenus" class="collapse" aria-labelledby="headingMenus" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="/menus">Data Menu</a>
                <a class="collapse-item" href="/menus/create">Form Menu</a>
            </div>
        </div>
    </li>

    <!-- Sliders Gallery Section -->
    ...
    <li class="nav-item">
        ...
        <div id="collapseSliders" class="collapse" aria-labelledby="headingSliders" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/sliders/create">Form Slider</a>
            </div>
        </div>
    </li>
</ul>
