                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-check mb-2">
                                    <input type="hidden" name="menu_access" value="0">
                                    <input type="checkbox" name="menu_access" value="1" class="form-check-input"
                                        id="menu_access"
                                        {{ isset($role) && isset($role->menu_access) && $role->menu_access == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check mb-2">
                                    <input type="hidden" name="about_us_gallery_access" value="0">
                                    <input type="checkbox" name="about_us_gallery_access" value="1"
                                        class="form-check-input" id="about_us_gallery_access"
                                        {{ isset($role) && isset($role->about_us_gallery_access) && $role->about_us_gallery_access == 1 ? 'checked' : '' }}>
